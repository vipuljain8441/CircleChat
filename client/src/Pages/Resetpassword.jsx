...
const Resetpassword = () => {
  ...
  return ( 
    <div className="w-full bg-bgColor h-[100vh] flex items-center  p-6 justify-center">
      <div className="bg-primary w-full md:w-1/3 2xl:w-1/4 px-6 py-8 shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex py-4 flex-col gap-5'>
          <TextInput
          name="email"
