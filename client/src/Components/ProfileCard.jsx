...
const ProfileCard = ({ user }) => {
  ...
  return (
    <div>
      <div className="w-full bg-primary flex-col items-center shadow0-sm rounded-xl px-4  py-4">
          ...
          <Link to={"/profile/" + user?._id} className="flex gap-2">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-lg font-medium text-ascent-1">
                {user?.firstName ?? "vipul"} {user?.lastName ?? "Jain"}
              </p>
        ...
        <div className="w-full flex flex-col gap-2 py-4 border-b border-[#66666645]">
          ...
          <span className="text-blue text-base">
            {user?.verified ? "Verified Accound" : "Not Verified"}
          </span>
          <div className="flex items-center justify-between">
